	...
	<div id="page-main" style="backgroud:#104d74;">
		...
		<form class="form-horizontal" method="post" action="User_updateInfo">
			...
			<div class="form-group">
				<label for="username" class="col-sm-1 col-sm-offset-4 control-label">&nbsp;用&nbsp;户&nbsp;名&nbsp;：</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="realname" class="col-sm-1 col-sm-offset-4 control-label">真实姓名：</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="email" class="col-sm-1 col-sm-offset-4 control-label">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="phone" class="col-sm-1 col-sm-offset-4 control-label">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="address" class="col-sm-1 col-sm-offset-4 control-label">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="zipcode" class="col-sm-1 col-sm-offset-4 control-label">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编：</label>
				<div class="col-sm-3">
	...
	<script type="text/javascript">
		$(document).ready(
			function() {
				$("#email").blur(function() {
					var value = $(this).val();
					if (value!=""&!/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/
							.test(value)) {
