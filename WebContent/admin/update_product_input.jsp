...
<body>
	<div id="page-main" style="backgroud:#104d74;">
			...
			<div class="form-group row">
				<label for="password" class="col-sm-1 col-md-offset-5 control-label">商品图片：</label>
				<div class="col-sm-3">
					<input name="upload" type="file">
				</div>
			</div>
			<div class="form-group row">
				<label for="password" class="col-sm-1 col-md-offset-5 control-label">所属分类：</label>
				<div class="col-sm-3">
