					...
					<div class="col-md-10">
						<table class="table table-bordered">
							<tr>
								...
								<td>订单状态： <s:if test="#order.state == 0">
										<span><a class="text-danger"
											href="Order_toPayOrder?oid=<s:property value="#order.oid"/>">未支付</a></span>
										...
										<span><a class="text-danger"
											href="Order_verifyReceiveGoods?oid=<s:property value="#order.oid"/>">确认收货</a></span>
